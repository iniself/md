    ...
    >
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-5 justify-items-center gap-2">
          <Button
            class="w-full" variant="outline" :class="{
              'border-black dark:border-white border-2': store.showPublish,
            }" @click="!store.showPublish && store.publishChanged()"
          >
            显示
          </Button>
          <Button
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-5 justify-items-center gap-2">
          <Button
            class="w-full" variant="outline" :class="{
              'border-black dark:border-white border-2': !store.isJustify,
            }" @click="store.isJustify && store.justifyChanged()"
          >
            靠左对齐
          </Button>
          <Button
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-5 justify-items-center gap-2">
          <Button
            class="w-full" variant="outline" :class="{
              'border-black dark:border-white border-2': store.isCenterHeader,
            }" @click="!store.isCenterHeader && store.centerHeaderChanged()"
          >
            居中
          </Button>
          <Button
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-5 justify-items-center gap-2">
          <Button
            class="w-full" variant="outline" :class="{
              'border-black dark:border-white border-2': store.isSvgCompatibility,
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-5 justify-items-center gap-2">
          <Button
            class="w-full" variant="outline" :class="{
              'border-black dark:border-white border-2': store.isAutoSync,
            }" @click="!store.isAutoSync && store.autoSyncChanged()"
          >
            自动
          </Button>
          <Button
