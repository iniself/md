...
function splitCells(tableRow, count, prevRow = [], skipEmptyRows) {
  ...
  const emptyCount = cells.filter(cell => cell.rowspan === 0).length
  if (cells.length > 0 && skipEmptyRows && cells.length === emptyCount) {
